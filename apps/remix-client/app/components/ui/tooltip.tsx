			...
			>
				<OverlayArrow>
					<svg
						...
						height={8}
						viewBox="0 0 8 8"
						className="fill-slate-700 forced-colors:fill-[Canvas] stroke-gray-800 forced-colors:stroke-[ButtonBorder] group-placement-bottom:rotate-180 group-placement-left:-rotate-90 group-placement-right:rotate-90 dark:fill-slate-600 dark:stroke-white/10"
					>
